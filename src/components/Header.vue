                ...
                <nav class="col-md-6 a mt-5 d-flex align-items-start justify-content-end">
                    ...
                    >
                        ...
                        <div id="carrito" class="bg-white p-3">
                            <p v-if="carritos.length < 1 " class="text-center">El carrito esta vacio</p>
                            <div v-else>
                                <table class="w-100 table">
                                    ...
                                    <tbody>
                                        <tr v-for="elemento in carritos">
                                            <td>
                                                <img class="img-fluid" :src="'img/'+ elemento.imagen + '.jpg'" :alt="'imagen guitarra' + elemento.nombre">
                                            </td>
